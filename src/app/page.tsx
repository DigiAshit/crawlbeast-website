...
import CrawlSimulation from "@/components/CrawlSimulation";
import { 
  ArrowUpRight, Star, ArrowRight, Check,
  Clock, ShieldAlert, Zap, Sparkles, AlertCircle, Plus, Cpu, Globe
} from "lucide-react";
      ...
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 overflow-hidden bg-grid-pattern">
        <div className="max-w-7xl mx-auto px-6 text-center flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-3 w-full sm:w-auto">
            <button
              onClick={openPopup}
              className="w-full sm:w-auto bg-gradient-to-r from-primary to-secondary text-white font-semibold py-3.5 px-8 rounded-lg text-sm cursor-pointer shadow-lg shadow-primary/20 hover:brightness-110 transition-all active:scale-95"
            >
              Start Your Free Audit
            </button>
            <button
              onClick={openPopup}
              className="w-full sm:w-auto bg-white/5 border border-white/10 hover:border-zinc-700 text-white font-semibold py-3.5 px-8 rounded-lg text-sm cursor-pointer transition-colors"
            >
              Watch Demo
            </button>
          </div>
      ...
      <section className="py-24 border-t border-white/5 bg-[#080b11]/50" id="about">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mt-12">
            <button
              onClick={openPopup}
              className="bg-gradient-to-r from-primary to-secondary text-white font-semibold py-3 px-8 rounded-lg text-sm cursor-pointer shadow-lg shadow-primary/15 transition-transform active:scale-95"
            >
              Download Now
            </button>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="bg-gradient-to-br from-primary/10 via-[#0e1320] to-[#0e1320] border border-white/5 rounded-2xl p-12 md:p-16 text-center flex flex-col items-center relative overflow-hidden shadow-2xl">
            ...
            <div className="flex gap-4">
              <button
                onClick={openPopup}
                className="bg-gradient-to-r from-primary to-secondary text-white font-semibold py-3 px-8 rounded-lg text-sm cursor-pointer shadow-lg shadow-primary/20 hover:brightness-110 active:scale-95 transition-all"
              >
                Download Now
              </button>
              <button
                onClick={() => window.location.href = '/pricing'}
                className="bg-white/5 border border-white/10 hover:border-zinc-700 text-white font-semibold py-3 px-8 rounded-lg text-sm cursor-pointer transition-colors"
              >
                View Pricing
              </button>
            </div>
