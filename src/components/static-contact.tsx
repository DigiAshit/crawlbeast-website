              ...
              {status === "success" ? (
                ...
                >
                  ...
                  <button
                    type="submit"
                    disabled={status === "loading"}
                    className="inline-flex items-center justify-center gap-1.5 rounded-lg bg-accent-blue hover:bg-blue-600 transition-colors font-semibold text-xs text-white py-3 mt-2 disabled:opacity-50 cursor-pointer"
                  >
                    {status === "loading" ? (
